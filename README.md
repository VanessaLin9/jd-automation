...
The generated dashboard worksheet includes starter metrics for applied count, application reply count, application reply rate, inbound invite count, total interest count, offer count, and offer rate among replied companies.
...
新建表時也會一併建立指標工作表，先提供投遞數、投遞回覆數、投遞回覆率、主動邀約數、市場回應總數、Offer 數與回覆後 Offer 率的基礎公式。
